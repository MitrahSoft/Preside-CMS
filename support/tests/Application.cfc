component {
	...
	this.javaSettings             = { LoadPaths = [ expandPath("..\..\system/services\encryption\bcrypt\lib\jbcrypt-0.3m.jar"), expandPath( "..\..\system/services\qrcodes\lib\" ) ], loadColdFusionClassPath = true, reloadOnChange= false };
