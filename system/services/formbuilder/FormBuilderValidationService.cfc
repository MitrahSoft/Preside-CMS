...
// PUBLIC API
	...
	public array function getStandardRulesForFormField( required string name ) {
		...
		if ( IsBoolean( StructKeyExists(arguments, "mandatory") ? arguments.mandatory : "" ) && arguments.mandatory ) {
			rules.append({ fieldname=arguments.name, validator="required" });
		}

		if ( IsNumeric( StructKeyExists(arguments, "maxLength") ? arguments.maxLength : "" ) && arguments.maxLength > 0 ) {
			if ( IsNumeric( StructKeyExists(arguments, "minLength") ? arguments.minLength : "" ) && arguments.minLength > 0 ) {
		...
		} else if ( IsNumeric( StructKeyExists(arguments, "minLength") ? arguments.minLength : "" ) && arguments.minLength > 0 ) {
			rules.append({ fieldname=arguments.name, validator="minlength", params={ length=Int( arguments.minLength ) } });
		}

		if ( IsNumeric( StructKeyExists(arguments, "maxValue") ? arguments.maxValue : "" ) && arguments.maxValue > 0 ) {
			if ( IsNumeric( StructKeyExists(arguments, "minValue") ? arguments.minValue : "" ) && arguments.minValue > 0 ) {
		...
		} else if ( IsNumeric( StructKeyExists(arguments, "minValue") ? arguments.minValue : "" ) && arguments.minValue > 0 ) {
