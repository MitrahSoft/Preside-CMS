...
<cfoutput>
	<cfloop array="#items#" index="item">
		...
		<div class="checkbox role-picker-radio">
			<label>
				<input class="#inputClass# ace ace-switch ace-switch-3" name="#inputName#" id="#itemId#" type="radio" value="#HtmlEditFormat( item.id )#"<cfif value eq item.id> checked="checked"</cfif> tabindex="#getNextTabIndex()#">
				<span class="lbl">
